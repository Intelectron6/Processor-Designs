...
Assember folder consists of a Python based assembler that converts assembly code to binary code. Assembly code is written in .txt format and the assembler prints the equivalent binary code, which is to be pasted in instruction_memory.v file. </br>
